...
const routes: Routes = [
  ...
  { path: 'modificar-producto', loadChildren: './productos/modificar-producto/modificar-producto.module#ModificarProductoPageModule' },
  ...
  { path: 'modificar-perfil', loadChildren: './sistema/perfiles/modificar-perfil/modificar-perfil.module#ModificarPerfilPageModule' },
  ...
  { path: 'modificar-opcion', loadChildren: './sistema/opciones/modificar-opcion/modificar-opcion.module#ModificarOpcionPageModule' },
  { path: 'modificar-parametro', loadChildren: './sistema/parametros/modificar-parametro/modificar-parametro.module#ModificarParametroPageModule' },
  { path: 'crear-categoria', loadChildren: './productos/categorias/crear-categoria/crear-categoria.module#CrearCategoriaPageModule' },
  { path: 'modificar-categoria', loadChildren: './productos/categorias/modificar-categoria/modificar-categoria.module#ModificarCategoriaPageModule' },
  ...
  { path: 'modificar-cliente', loadChildren: './clientes/modificar-cliente/modificar-cliente.module#ModificarClientePageModule' },
